...
import { CircularProgress, IconButton, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Button, Select, MenuItem, FormControl, InputLabel } from "@mui/material";
        ...
        {filteredRecipes.length > 0 ? (
          ...
          !error && (
            <div className="empty-state fade-in delay-1">
              ...
              <p>אולי כדאי לנסות שילוב סינונים אחר!</p>
            </div>
          )
        )}
      </div>
