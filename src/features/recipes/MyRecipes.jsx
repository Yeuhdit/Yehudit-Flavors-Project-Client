...
const MyRecipes = () => {
  ...
  const filteredRecipes = myRecipes.filter(r => r.name?.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    <div className="recipes-wrapper" dir="rtl">
      ...
      <div className="recipes-container">
        <header className="recipes-header fade-in">
          <h1 className="super-title">המתכונים <span className="text-highlight">שלי.</span></h1>
          <p style={{ color: '#666', fontSize: '1.2rem', marginTop: '10px' }}>כל היצירות והמתכונים ששמרת במקום אחד</p>
          <div className="search-glass-container">
            <SearchRoundedIcon className="search-icon" />
            <input type="text" className="search-glass-input" placeholder="חיפוש במתכונים שלי..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
          </div>
        </header>
